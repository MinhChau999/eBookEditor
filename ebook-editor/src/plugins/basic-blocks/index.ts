...
const basicBlocks: Plugin = (editor: Editor) => {
  ...
  bm.add('column1', {
    ...
    content: `<div class="${clsRow}">
        <div class="${clsCell}"></div>
      </div>`,
  });
  ...
  bm.add('column3-7', {
    ...
    content: `<div class="${clsRow}">
        <div class="${clsCell}" style="flex-basis: 30%;"></div>
        <div class="${clsCell}" style="flex-basis: 70%;"></div>
      </div>`,
  });
