...
export default grapesjs.plugins.add('ruler', (editor: Editor, opts: RulerPluginOptions = {}) => {
    const options = {
        // default options
        dragMode: 'translate',
        rulerHeight: 15,
    ...
    cm.add('ruler-visibility', {
        run(editor: Editor) {
            ...
            // editor.setDragMode(options.dragMode); // Optional: might conflict with other drag modes
            setOffset();
